class Test(unittest.TestCase):
  ...
  def test_exemplo_2(self):
    self.assertEquals($forecast(40, True), "Amanhã há chances médias de chuva com vento")
  ...
  def test_menos_de_$corteAlta(self):
    self.assertEquals($forecast($corteAlta-1, False), "Amanhã há chances médias de chuva sem vento")
